...
(such as in a container) and the host system is trusted,
and all services running in a single container share a trust boundary.
...
4. Distribution via _SECRETSLOC_
   ...
   EdgeX supports runtime environments such as standard Docker
