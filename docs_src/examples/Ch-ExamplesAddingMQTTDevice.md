         ...
         "coreCommands" : [
            {
               "name" : "values",
               "get" : true,
               "path" : "/api/{{api_version}}/device/name/my-custom-device/values",
            ...
            },
            {
               ...
               "name" : "message",
               "get" : true,
               "path" : "/api/{{api_version}}/device/name/my-custom-device/message",
               "set" : true
            },
            {
                "name": "json",
                "get": true,
                "set": true,
                "path": "/api/{{api_version}}/device/name/MQTT-test-device/json",
                "url" : "http://edgex-core-command:59882",
                "parameters": [
                    {
                        "resourceName": "json",
...
```
$ curl http://localhost:59882/api/{{api_version}}/device/name/my-custom-device/message \
...
```json
$ curl http://localhost:59882/api/{{api_version}}/device/name/my-custom-device/message | json_pp
...
```json
$ curl http://localhost:59880/api/{{api_version}}/reading/resourceName/message | json_pp
...
```json
$ curl http://localhost:59880/api/{{api_version}}/reading/resourceName/randnum | json_pp
