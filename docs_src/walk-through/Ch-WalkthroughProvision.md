...
There are many [additional APIs on core metadata](https://app.swaggerhub.com/apis/EdgeXFoundry1/core-metadata/2.1.0) to retrieve a `DeviceProfile`, `Device`, `DeviceService`, etc. As an example, here is one to find
