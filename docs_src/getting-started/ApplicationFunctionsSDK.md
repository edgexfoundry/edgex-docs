...
```
Set the Trigger type to `http` in [res/configuration.toml](https://github.com/edgexfoundry/edgex-examples/blob/{{latest_released_version}}/application-services/custom/simple-filter-xml/res/configuration.toml)
