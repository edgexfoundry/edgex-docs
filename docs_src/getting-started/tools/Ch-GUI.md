...
For more details please refer to [edgex-ui Snap](https://github.com/edgexfoundry/edgex-ui-go/blob/{{version}}/snap/README.md)

### Native
If you are running EdgeX natively (outside of Docker Compose or a Snap), you will find instructions on how to build and run the GUI on your platform in the [GUI repository README](https://github.com/edgexfoundry/edgex-ui-go/blob/{{version}}/README.md)
