...
- the number of [notifications](../../microservices/support/notifications/Purpose.md) EdgeX has seen
...
[Notifications](../../microservices/support/notifications/Purpose.md) are messages from EdgeX to external systems about something that has happened in EdgeX - for example that a new device has been created.  Currently, notifications can be sent by email or REST call.
