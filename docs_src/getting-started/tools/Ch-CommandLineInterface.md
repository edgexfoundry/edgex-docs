...
Name               BaseAddress             Description  AdminState  Id                                    Labels      Modified
TestDeviceService  http://localhost:51234               UNLOCKED    7f29ad45-65dc-46c0-a928-00147d328032  []          10 Jan 22 17:26 GMT
...
$ edgex-cli deviceservice name -n TestDeviceService -v
Name               BaseAddress             Description  AdminState  Id                                    Labels           Modified
TestDeviceService  http://localhost:51234               UNLOCKED    844473b1-551d-4545-9143-28cfdf68a539  [label1 label2]  28 Jan 22 12:00 GMT
```
{% endraw %}
