...
| [Installation][edgexfoundry] | [Configuration] | [Managing Services] | [Debugging] | [Source](https://github.com/edgexfoundry/edgex-go/tree/{{edgexversion}}/snap) |
...
### EdgeX UI
| [Installation][edgex-ui] | [Managing Services] | [Debugging] | [Source](https://github.com/edgexfoundry/edgex-ui-go/tree/{{edgexversion}}/snap) |
...
| [Installation][edgex-app-service-configurable] | [Configuration] | [Managing Services] | [Debugging] | [Source](https://github.com/edgexfoundry/app-service-configurable/tree/{{edgexversion}}/snap) |
...
??? example "Filtering devices using snap options"
    ...
    For example, to [filter by device names](../../microservices/application/services/AppServiceConfigurable/details/AvailablePipelineFunctions/#filterbydevicename) `Random-Integer-Device` and `Random-Binary-Device` using snap options:
    ```
...
Please refer to [App Service Configurable](../../microservices/application/services/AppServiceConfigurable/details/Purpose/) guide for detailed usage instructions.
...
| [Installation][edgex-app-rfid-llrp-inventory] | [Configuration] | [Managing Services] | [Debugging] | [Source](https://github.com/edgexfoundry/app-rfid-llrp-inventory/tree/{{edgexversion}}/snap) |
...
The aliases need to be provided for the service to work.  See [Setting the Aliases](https://github.com/edgexfoundry/app-rfid-llrp-inventory/blob/{{edgexversion}}/README.md#setting-the-aliases).
...
### Device GPIO
| [Installation][edgex-device-gpio] | [Configuration] | [Managing Services] | [Debugging] | [Source](https://github.com/edgexfoundry/device-gpio/tree/{{edgexversion}}/snap) |
...
### Device Modbus
| [Installation][edgex-device-modbus] | [Configuration] | [Managing Services] | [Debugging] | [Source](https://github.com/edgexfoundry/device-modbus-go/tree/{{edgexversion}}/snap) |
...
### Device MQTT
| [Installation][edgex-device-mqtt] | [Configuration] | [Managing Services] | [Debugging] | [Source](https://github.com/edgexfoundry/device-mqtt-go/tree/{{edgexversion}}/snap) |
...
### Device REST
| [Installation][edgex-device-rest] | [Configuration] | [Managing Services] | [Debugging] | [Source](https://github.com/edgexfoundry/device-rest-go/tree/{{edgexversion}}/snap) |
...
### Device RFID LLRP
| [Installation][edgex-device-rfid-llrp] | [Configuration] | [Managing Services] | [Debugging] | [Source](https://github.com/edgexfoundry/device-rfid-llrp-go/tree/{{edgexversion}}/snap) |
...
- Using `snap set` to set your local subnet information. Example:
    ...
    curl -X POST http://localhost:59989/api/{{api_version}}/discovery
    ```
...
### Device SNMP
| [Installation][edgex-device-snmp] | [Configuration] | [Managing Services] | [Debugging] | [Source](https://github.com/edgexfoundry/device-snmp-go/tree/{{edgexversion}}/snap) |
...
### Device USB Camera
| [Installation][edgex-device-usb-camera] | [Configuration] | [Managing Services] | [Debugging] | [Source](https://github.com/edgexfoundry/device-usb-camera/tree/{{edgexversion}}/snap) |
...
### Device Virtual
| [Installation][edgex-device-virtual] | [Configuration] | [Managing Services] | [Debugging] | [Source](https://github.com/edgexfoundry/device-virtual-go/tree/{{edgexversion}}/snap) |
...
### Device ONVIF Camera
| [Installation][edgex-device-onvif-camera] | [Configuration] | [Managing Services] | [Debugging] | [Source](https://github.com/edgexfoundry/device-onvif-camera/tree/{{edgexversion}}/snap) |
...
[edgexfoundry-src]: https://github.com/edgexfoundry/edgex-go/tree/{{edgexversion}}/snap
[edgex-ui]: https://snapcraft.io/edgex-ui
[edgex-ui-src]: https://github.com/edgexfoundry/edgex-ui-go/tree/{{edgexversion}}/snap
